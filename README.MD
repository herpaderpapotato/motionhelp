...
You use this to build a dataset from your existing content.
And then you train a model on the data.
And that helps you build an even bigger dataset.
And that lets you train a version that really nails the tempo and magnitude on 95% of sequences, especially on the longer and more tedious scripts which free's you up to focus on the bigger questions like, *should I be basing the pos on the hand, or the mouth in this scene?*
